...
public class ContingentBeneficiariesDeleteTest extends TestNGBase {
    ...
    public void ValidateContingentBeneficiariesDelete(@Optional("data/beneficiaries_skip_data_set_en.xml")String dataSet,
                                                    @Optional("data/contingent_beneficiaries_delete_data_set_en.xml")String dataSet2) {
