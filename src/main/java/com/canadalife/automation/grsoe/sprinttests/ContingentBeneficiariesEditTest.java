...
public class ContingentBeneficiariesEditTest extends TestNGBase {

    @Features("Sprint15")
    @Stories("Member can edit a Contingent Beneficiary")
    @Parameters({"data-set","data-set2"})
    @Issue("GRSOE-581")
    @Test

    public void ValidateContingentBeneficiariesEdit(@Optional("data/beneficiaries_quebec_data_set_fr.xml")String dataSet,
                                                    @Optional("data/contingent_beneficiaries_quebec_data_set_fr.xml")String dataSet2) {
        ...
        And(contingentbeneficiariesDO :: user_validates_quebec_question_and_checks_revocable_option);
        And(contingentbeneficiariesDO :: user_clicks_save_beneficiary);
        And(contingentbeneficiariesDO :: user_validates_salesforce_information_is_true_for_revocable);
        And(contingentbeneficiariesDO :: user_edits_beneficiary_person_information);
        And(contingentbeneficiariesDO :: user_validates_salesforce_information_is_false_for_revocable);
    }
}
