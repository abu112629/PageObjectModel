...
import ui.auto.core.support.DriverProvider;
...
public class MobileDriverProvider implements DriverProvider {
    /*
        ...
        public WebDriver getNewDriverInstance() {
            ...
            switch (getBrowserType()) {
                ...
                case CHROME:
                    ...
                    String [] settings=prop.getUserAgent().split(",");
                    if(settings[0].trim().toLowerCase().equals("mobile")){
                        Map<String,String> emulation=new HashMap<>();
                        emulation.put("deviceName",settings[1]);
